...
<section class="fullscreen-banner p-0 overflow-hidden">
  <div class="banner-slider owl-carousel no-pb">
    <div class="item" data-bg-img="images/bg/2.png">
    ...
    <div class="item white-overlay" data-bg-img="images/bg/3.png" data-overlay="8">
      <div class="align-center pt-0">
        <div class="container">
    ...
    <div class="item" data-bg-img="images/bg/1.png">
      <div class="align-center pt-0">
        <div class="container">
