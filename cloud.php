  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-12">
        <h1 class="title mb-0">Cloud <br> <span>Solutions</span></h1>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="service-details mt-4" style="text-align: left;">
          <h2 class="title">Cloud <span>Solutions</span></h2>
          <p class="lead">Cloud services are services available via a remote cloud computing server rather than an on-site server. These scalable solutions are managed by a third party and provide users with access to computing services such as analytics or networking via the internet.
