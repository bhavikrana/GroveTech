  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-12">
        <h1 class="title mb-0">Website<br> <span>Development</span></h1>
      </div>
        ...
        <div class="widget mb-5">
          <div class="sidebar-links">
            <ul class="list-unstyled list-unstyled-web">
              <li class="menu-tab" id="web-1"><a><i class="fas fa-angle-right"></i> React</a>
              </li>
              <li class="menu-tab" id="web-2"><a><i class="fas fa-angle-right"></i> Angular </a>
              </li>
              <li class="menu-tab" id="web-3"><a><i class="fas fa-angle-right"></i> Mean/Mern Stack</a>
              </li>
              <li class="menu-tab" id="web-4"><a><i class="fas fa-angle-right"></i>Vue</a>
              </li>
              <li class="menu-tab" id="web-5"><a><i class="fas fa-angle-right"></i> NodeJs</a>
              </li>
              <li class="menu-tab" id="web-6"><a><i class="fas fa-angle-right"></i> React Native</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="service-details mt-4" style="text-align: left;">
          <h2 class="title">Websites And <span>Application</span></h2>
          <p class="lead">Our website developers provide expert web application development, web design services, responsive website designs, back-end and APIs to our clients. We mingle various web components for full range web development scenarios, unique ideas, and business models.

          </p>
          <p class="mb-0"> Building a web application is a highly cost-effective and flexible approach. We have a team of expert web application developers who strive to fulfill your business requirements.</p>
          <br>
          <p class="mb-0"> Our experts are able to develop websites and web applications in a variety of languages including PHP, .Net, WordPress, Python and many more. With multi-browser compatibility and high performing functionalities, we can tailor any design to suit your needs.</p>
